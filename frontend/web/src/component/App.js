...
class App extends React.Component {
  ...
  render() {
    return (
      <Grid container maxWidth="md" spacing={3} alignItems="center" alignContent="center" justify="center" style={{}}>
        <CssBaseline />
        <Grid item xs={2}></Grid>
        ...
        <Grid item xs={4} align="center" >
          <Button variant="contained" color="primary" onClick={this.toSignupPage}>Signup for VocabJotDown</Button>
        </Grid>
        <Grid item xs={4} />
